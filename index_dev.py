...
if form1_bt:
    if all_yn_box :
        df = get_cps_data(start_dt, end_dt, all_yn_box)
    else:
        df = get_cps_data(start_dt, end_dt, all_yn_box, corp_code)
    st.dataframe(df)